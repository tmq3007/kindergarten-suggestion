    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/user/check-phone-exist-except").permitAll()
                                .requestMatchers("/api/user/check-email-exist").permitAll()
                                .requestMatchers("/api/user/check-email-exist-except").permitAll()
