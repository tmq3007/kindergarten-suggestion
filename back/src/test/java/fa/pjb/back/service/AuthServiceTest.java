...
public class AuthServiceTest {
    ...
    public void forgotPassword_Success() throws MessagingException {
        ...
        when(emailService.sendLinkPasswordResetEmail("user@example.com", "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123"))
        ...
        verify(emailService, times(1)).sendLinkPasswordResetEmail("user@example.com", "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123");
    ...
    public void forgotPassword_Boundary_MinValidEmail() throws MessagingException {
        ...
        when(emailService.sendLinkPasswordResetEmail("a@b.co", "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123"))
                .thenReturn("Link password reset sent successfully!");
        when(jwtHelper.generateForgotPasswordToken("username123")).thenReturn("token123");
        ...
        verify(emailService, times(1)).sendLinkPasswordResetEmail("a@b.co", "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123");
    }
    ...
    public void forgotPassword_NearBoundary_LongValidEmail() throws MessagingException {
        ...
        when(emailService.sendLinkPasswordResetEmail(longEmail, "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123"))
                .thenReturn("Link password reset sent successfully!");
        when(jwtHelper.generateForgotPasswordToken("username123")).thenReturn("token123");
        ...
        verify(emailService, times(1)).sendLinkPasswordResetEmail(longEmail, "username123", "http://localhost:3000/forgot-password/reset-password?username=username123&token=token123");
    }
