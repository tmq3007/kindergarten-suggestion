...
const Profile = () => {
    ...
    return (
        ...
        }} className="min-h-screen mt-14 bg-teal-100 bg-opacity-60">
            {contextHolder}
            <div className="container mx-auto mt-10 px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                     {/* Sidebar Column */}
                    <div className="col-span-1 ">
                        <div className="bg-teal-100 bg-opacity-60 rounded-lg shadow-md p-6 h-full">
                            <ProfileSidebar
                                fullname={parentData?.data?.fullname}
                                email={parentData?.data?.email}
                                                        ...
                                                        {countries?.map((country) => (
                                                            ...
                                                            >
                                                                <div className="flex items-center">
                                                                    <img src={country.flag} alt={country.label}
                                                                         width={20} height={10} className="mr-2 ml-3"/>
