        ...
        <Editor
            ...
            init={{
                ...
                plugins: [
                    ...
                    'advtable advcode editimage advtemplate ai mentions tinycomments tableofcontents footnotes mergetags autocorrect typography inlinecss',
                ...
                ai_request: (request: AIRequest, respondWith: any) => {
