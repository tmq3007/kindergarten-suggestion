...
//     const handleSchoolNameChange = async (expectedSchool: string, BRN?: string) => {
//         if (!expectedSchool || isReadOnly) {
//             setOwnerOptions([]);
//             return;
//         }
//
//         try {
//             const result = await triggerSearchSchoolOwners({expectedSchool, BRN}).unwrap();
...
//     };
//     useEffect(() => {
//         const selectedSchool = schoolOptions.find(option => option.value === schoolNameValue);
//         const BRN = selectedSchool?.BRN;
//         handleSchoolNameChange(schoolNameValue, BRN).then(() => {
//         });
//     }, [schoolNameValue]);
//
//     useEffect(() => {
...
//             setSchoolOptions(
//                 expectedSchoolData.data.map((expectedSchool: ExpectedSchool, index: number) => ({
//                     label: (
//                         <div>
...
//                         ? `${expectedSchool.expectedSchool}-${expectedSchool.BRN}` // Composite key
//                         : `${expectedSchool.expectedSchool}-${index}` // Fallback to index if no BRN
//                 }))
//             );
//         }
//     }, [expectedSchoolData]);
